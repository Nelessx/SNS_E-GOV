...
export default function PersonalInformation({
    ...
    const [placeOfBirth, setPlaceOfBirth] = useState(formData.placeOfBirth || "")
    const [fathersName, setFathersName] = useState(formData.fathersName || "")
    const [mothersName, setMothersName] = useState(formData.mothersName || "")
    ...
    }, [firstName, lastName, dateOfBirth, email, phone, placeOfBirth, fathersName, mothersName, familyMembers, updateFormData, validateStep, stepIndex])
